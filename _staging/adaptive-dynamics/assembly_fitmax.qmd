...
This vignette provides an example of running community assembly using the max_fitness method in  regnans. Below we consider both a 1 and 2 trait example.
