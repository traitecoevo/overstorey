...
How the `plant` source is laid out, how we develop it (gitflow, testing, CI),
how to compile it, and how the R/C++ interface is generated. Aimed at
contributors working on the package itself.

## Development

### Directory structure

The code is organised as follows. This structure reflects the structure
generally used for R packages including C++ source.
...
::: {.callout-note}
The workflow itself — issues and the board, feature branches, what the automated
checks do and don't prove, squash merges, and what a reviewer is looking for — is
set out in [How we work](how-we-work.qmd). This section covers only the parts
specific to building this package.
:::
...
<!-- dropped: empty section in source (no content authored) -->
...
Website maintained on a separate branch [`gh-pages`](https://github.com/traitecoevo/plant/tree/gh-pages).
Website built with [pkgdown](http://pkgdown.r-lib.org), drawing on files in the package such as
