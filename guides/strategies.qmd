...
LMA as affecting a number of other components of the model — see
[FF16](../theory/models/ff16.qmd) for the trait trade-offs this
functional-balance model builds in.
...
the ODE and schedule tolerances (see [ODE stepping & control](../theory/implementation/ode-stepping.qmd)
and [The node-spacing algorithm](../theory/implementation/node-spacing.qmd)). We
can see which fields it changes:
